...
# Copyright (c) 2017-2021 CloudNetEngine.
...
BUILDROOT_NAME='buildroot-2021.02.6'
...
img_name="${BUILD_DIR}/cne-ovs-sit-vm-${VERSION}.img"
...
wget -P ${BUILD_DIR} -N $BUILDROOT_URL --no-check-certificate
...
sudo cp ${BUILDROOT_DIR}/output/images/bzImage ${MOUNT_TMPDIR}/boot
...
sudo ${BUILDROOT_DIR}/output/host/sbin/grub-bios-setup \
     -b ${BUILDROOT_DIR}/output/host/lib/grub/i386-pc/boot.img \
     -c ${BUILDROOT_DIR}/output/images/grub.img -d . /dev/loop0
